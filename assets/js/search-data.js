...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "Publications",
          description: "Some more cool research work is ongoing. Stay tuned.",
          section: "Navigation",
          handler: () => {
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-promoted-to-software-engineer-ii-at-my-current-role",
          title: 'Promoted to Software Engineer II at my current role.',
          description: "",
